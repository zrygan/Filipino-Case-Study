...
\begin{enumerate}
      ...
      \item
            ...
            \end{example}
            \begin{enumerate}
                  \item \textbf{twit-twit} (correct) \\
                        \textit{twittwit} (incorrect)
                  \item \textbf{rat-at-tat} (correct) \\
                        \textit{ratattat} (incorrect)
                  \item \textbf{ding-dong} (correct) \\
                        \textit{dingdong} (incorrect)
            \end{enumerate}
      ...
      \item
            ...
            \end{example}
            \begin{enumerate}
                  \item \textbf{tag-ulan} ng tanghali. (correct) \\
                        \textit{tagulan} ng tanghali. (incorrect)
                  \item \textbf{taga-Makati} ng Pebrero. (correct) \\
                        \textit{tagamakati} ng Pebrero. (incorrect)
                  \item \textbf{nag-Polish} anibersaryo. (correct) \\
                        \textit{nagpolish} anibersaryo. (incorrect)
            \end{enumerate}
      \item
            Let \(h\) \in \(\mathbb{Z}^+\) and the hour of the day.
            \[
            k = (\text{"alas"}) \cdot "\text{-}" \cdot h
            \]
            While "alas" is limited to the hour of the day "ika" is not.\\
            Let \(t\) be an integer that denotes time, where \(t\) \in \(\mathbb{Z}^+\) and \(t \in \mathbb{K}\), and K = \(H \ \cup \ D \ \cup \\).
            \[
            k = (\text{"ika"}) \cdot "\text{-}" \cdot t
            \]
            A \textit{gitling} is used to separate the syllable ("ika" and "alas") with an integer of time.
            \begin{example}
            \end{example}
            \begin{enumerate}
                  \item \textbf{alas-2} ng tanghali. (correct) \\
                        \textit{alas2} ng tanghali. (incorrect)
                  \item \textbf{ika-2} ng Pebrero. (correct) \\

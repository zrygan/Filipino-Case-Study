...
\begin{enumerate}
      \item  ...kailangang bitayin si Rizal \textbf{nang} matakot... (correct)
            \\ ...kailangang bitayin si Rizal \textit{ng} matakot... (correct)
      \item Dinala si Pedro sa ospital \textbf{nang} magamot. (correct)
            \\ Dinala si Pedro sa ospital \textit{ng} magamot. (incorrect)
      \item Nag-ipon siya \textbf{nang} makabili... (correct)
            \\ Nag-ipon siya \textit{ng} makabili... (correct)
\end{enumerate}

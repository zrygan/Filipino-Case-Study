...
It follows that, if a grammar rule cannot be expressed as a CFG, then expressing it as Java code since Java is \textit{turing complete}. Thus, it is strictly more powerful than a CFG \cite{church_turing}.

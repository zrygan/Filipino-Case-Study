...
% FIXME: add citation to this later: 
% REFERENCE: https://standards.ieee.org/ieee/1003.1/7700/
Although the notation for regular expressions uses formal notation, for simplicity, syntax from the \texttt{IEEE POSIX} is occasionally used in the following chapters:
\begin{itemize}
    \item 
\end{itemize}
